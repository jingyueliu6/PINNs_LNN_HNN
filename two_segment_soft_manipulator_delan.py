...
'''
with open(f"../data/two_segment_spatial_soft_robot_resample_data_1000Hz.jax", 'rb') as f:
...
if save_model:
    with open(f"./models/two_segment_spatial_soft_robot_1000Hz.jax", "wb") as file:
        pickle.dump(
            {"epoch": epoch_i,
             "hyper": hyper,
             "params": params},
